...
p = pbmc.combined[,pbmc.combined$seurat_clusters %in% c(12, 23, 11, 32)] %>% DimPlot(object =., reduction = "tsne", label = TRUE, pt.size = 0.5) + NoLegend()
 ggsave("results/.figs/pbmc.combined.tsne.selected.pdf", plot=p) 

pbmc.combined.sel = pbmc.combined[,pbmc.combined$seurat_clusters %in% c(12, 23, 11, 32, 19 , 13, 7, 24, 2, 15)]
pbmc.combined.sel$is.tgd = ifelse(pbmc.combined.sel$seurat_clusters ==12, 1, 0)
pbmc.combined.sel %>% FindVariableFeatures(method="vst")
genes.sel = intersect(VariableFeatures(pbmc.combined.sel), rownames(lee.sco)) %>%
...
output.dir = "/liulab/asahu/projects/icb/data/gdt/pbmc.gdt_t_nk"
write.dataset(output.dir = "/liulab/asahu/projects/icb/data/gdt/pbmc.gdt_t_nk", dataset = dataset, sample.name = colnames(pbmc.combined.sel))

file.copy("/liulab/asahu/projects/icb/data/icb/tf/params.json", output.dir)
file.copy("/liulab/asahu/projects/icb/data/icb/tf/datasets_tsne_list.txt", output.dir)
file.copy("/liulab/asahu/projects/icb/data/icb/scrna_transer/howard/datasets_test_list.txt", output.dir)

## Shell script 
# python train.py  --data_dir  ~/project/deeplearning/icb/data/gdt/pbmc.gdt_t_nk/datasets_tsne_list.txt --model_dir ~/project/deeplearning/icb/data/gdt/pbmc.gdt_t_nk/. 
## 


output.dir1 = "/liulab/asahu/projects/icb/data/gdt/pbmc.gdt_t_nk/GSE145281"
...
output.dir1 = "/liulab/asahu/projects/icb/data/gdt/pbmc.gdt_t_nk/lee.sco"
...
# python evaluate.py  --data_dir  ~/project/deeplearning/icb/data/gdt/pbmc.gdt_t_nk/datasets_test_list.txt --model_dir ~/project/deeplearning/icb/data/gdt/pbmc.gdt_t_nk/tensorboardLog/20200601-234127/. --restore_file  ~/project/deeplearning/icb/data/gdt/pbmc.gdt_t_nk/tensorboardLog/20200601-234127/epoch-51.pth.tar --output_dir  ~/project/deeplearning/icb/data/gdt/pbmc.gdt_t_nk/tensorboardLog/20200601-234127/outputs/



## read dataset 
gdt.out = fread("/liulab/asahu/projects/icb/data/gdt/pbmc.gdt_t_nk/tensorboardLog/20200601-234127/outputs/val_1_prediction.csv")
# samp.names = fread("/liulab/asahu/projects/icb/data/gdt/pbmc.gdt_t_nk/GSE145281/samples_name.txt")
...
gdt.out = fread("/liulab/asahu/projects/icb/data/gdt/pbmc.gdt_t_nk/tensorboardLog/20200601-234127/outputs/val_2_prediction.csv")
